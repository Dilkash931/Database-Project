...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['checkout'])) {
        ...
        if (password_verify($password, $passRow['password'])){ 
            $sql = "INSERT INTO `orders` (`userId`, `address`, `phoneNo`, `amount`, `paymentMode`, `orderStatus`, `orderDate`) VALUES ('$userId', '$address', '$phone', '$amount', '$paymentMode', '0', current_timestamp())";
            $result = mysqli_query($conn, $sql);
